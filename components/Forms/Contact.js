...
import logo from '~public/images/ventleytech-logo.svg';
    ...
    <div className={classes.formWrap}>
      ...
      {!isDesktop && (
        <div className={cx(classes.logo, classes.logoHeader)}>
          <a href={curLang + routeLink.ventleytech.home}>
            <img src={logo} alt="logo" />
          </a>
        </div>
      )}
      {!isTablet && (
        <IconButton component={Link} href={routeLink.ventleytech.home} className={classes.backtohome} size="large">
          <span>
